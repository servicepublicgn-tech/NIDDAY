...
export const metadata = createPageMetadata({
  title: "Documentation",
  description:
    "Learn how to use NIDDAY to run your business. Get answers about invoicing, banking, time tracking, reports, and more.",
  path: "/docs",
  og: {
    title: "Documentation",
    description: "Everything you need to know about NIDDAY",
  },
});
...
const popularGuides = [
  {
    ...
    description: "What is NIDDAY and how it helps you",
  },
  {
    title: "Quick Start",
