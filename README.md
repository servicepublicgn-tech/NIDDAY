...
See [the Phase 1 architecture report](docs/nidday-phase-1-audit.md) for the audited state, safe rename boundary, deployment model, health-check findings, and incremental migration plan. The first Phase 2 database security and traceability foundation is documented in [Phase 2 foundation](docs/nidday-phase-2-foundation.md).
